...
// Settings APIs (for settings page)
...
export const couponsAPI = {
  ...
  create: (couponData) => api.post('/coupons/create/', couponData),
  getById: (couponId) => api.get(`/coupons/${couponId}/`),
  update: (couponId, couponData) => api.put(`/coupons/${couponId}/update/`, couponData),
  toggleStatus: (couponId) => api.post(`/coupons/${couponId}/toggle-status/`),
  delete: (couponId) => api.delete(`/coupons/${couponId}/delete/`)
};